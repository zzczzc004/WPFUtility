...
{
    public class ScrollViewerCorrectorBehavior
    {
        ...
        public static readonly DependencyProperty FixScrollingProperty =
            DependencyProperty.RegisterAttached("FixScrolling", typeof(bool), typeof(ScrollViewerCorrectorBehavior), new FrameworkPropertyMetadata(false,ScrollViewerCorrectorBehavior.OnFixScrollingPropertyChanged));
